...
export const AM_URL = useLiveOauth
  ? process.env.AM_URL
  : 'https://forgerock-sdk-samples.com:3001/am';
export const BASE_URL = useLiveOauth
  ? process.env.BASE_URL
  : 'https://forgerock-sdk-samples.com:3002';
export const CHROME_PATH = process.env.CHROME_PATH;
export const CLIENT_ID = process.env.CLIENT_ID;
export const PASSWORD = process.env.PASSWORD;
export const REALM_PATH = process.env.REALM_PATH;
export const RESOURCE_URL = 'https://forgerock-sdk-samples.com:3001/resource';
