...
describe('Test Second Factor login flow', function () {
  beforeAll(function () {
    jest.retryTimes(3);
  });
  browsers_1['default'].map(function (browserType) {
    it('should login successfully with OTP and then log out with ' + browserType, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, setup_and_go_1.setupAndGo)(browserType, 'authn-second-factor/'),
              ];
            case 1:
