...
describe('Test request middleware with login flow', function () {
  beforeAll(function () {
    jest.retryTimes(3);
  });
  browsers_1['default'].map(function (browserType) {
    it('Full login and oauth using middleware at Config with ' + browserType, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, setup_and_go_1.setupAndGo)(browserType, 'config-request-middleware/', {
    ...
    it('Full login and oauth using middleware at Call Site with ' + browserType, function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var _a, browser, messageArray, error_2;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              _b.trys.push([0, 3, , 4]);
