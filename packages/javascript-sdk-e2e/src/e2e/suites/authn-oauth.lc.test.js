...
describe('Test OAuth login flow', function () {
  ...
  browsers_1['default'].map(function (browserType) {
    it('should login successfully and then log out with ' + browserType, function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var _a, browser, messageArray, networkArray, revokeRequests, error_1;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              _b.trys.push([0, 3, , 4]);
              return [4 /*yield*/, (0, setup_and_go_1.setupAndGo)(browserType, 'authn-oauth/')];
            case 1:
              (_a = _b.sent()),
                (browser = _a.browser),
              ...
              revokeRequests = networkArray.filter(function (request) {
                return request === '/am/oauth2/realms/root/token/revoke, fetch';
              });
