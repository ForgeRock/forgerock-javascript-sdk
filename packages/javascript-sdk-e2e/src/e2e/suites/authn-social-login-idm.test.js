...
describe('Test Social Login flow with AM nodes', function () {
  beforeAll(function () {
    jest.retryTimes(3);
  });
  browsers_1['default'].map(function (browserType) {
    it('Login with identity provider on  ' + browserType, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, setup_and_go_1.setupAndGo)(browserType, 'authn-social-login-idm/', {
