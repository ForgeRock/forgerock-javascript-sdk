...
describe('Test oauth login flow with localStorage', function () {
  beforeAll(function () {
    jest.retryTimes(3);
  });
  browsers_1['default'].map(function (browserType) {
    it('Login successfully with ' + browserType, function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, setup_and_go_1.setupAndGo)(browserType, 'config-token-storage/', {
    ...
    it('Login successfully with ' + browserType, function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var _a, browser, messageArray, error_3;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              _b.trys.push([0, 3, , 4]);
