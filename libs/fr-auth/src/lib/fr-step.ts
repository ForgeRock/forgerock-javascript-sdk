...
import { FRCallbackFactory, FRCallback, Callback } from '@forgerock/libs/fr-callback';
import { createCallback } from '@forgerock/libs/fr-callbacks';
